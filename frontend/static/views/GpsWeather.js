...
GpsWeather.prototype = Object.create(StdView.prototype);

GpsWeather.prototype.create_dom_view = function(entry){
    var spec = {
        "temperature": [
            "Current temperature",
    ...
    this.entry_div.css("background-color", "rgba(0, 128, 0, .1)");
